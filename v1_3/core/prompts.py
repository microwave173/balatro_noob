...
- Run, blind, round resources, Jokers, consumables, hand cards, remaining-deck counts, poker hand levels, shop contents, learned rulebook guidance, and legal actions.
...
BLIND_PLAN_SCHEMA = """Tool arguments:
{
