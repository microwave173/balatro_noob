...
from v1_3.core.memory import read_jsonl


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Reflect on v1.3 memories and rewrite rulebook guidance")
    ...
    p.add_argument("--reasoning-effort", default="high", choices=["low", "medium", "high"], help="Thinking strength when reflection thinking is enabled")
...
def main() -> None:
    ...
    prompt = {
        "task": "Reflect on Balatro v1.3 play/shop memories and rewrite the complete rulebook.",
        "output_contract": {
