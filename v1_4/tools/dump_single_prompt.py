...
from v1_4.core.deepseek_policy import _decision_user, _strict_schema
from v1_4.core.observation import render_observation_text
from v1_4.core.prompts import (
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Dump the exact single-input prompt text for a v1.4 play decision.")
    p.add_argument("--input", default="v1_4/test_inputs/play_decision_ante1_pair.json")
    p.add_argument("--output", default="v1_4/test_inputs/play_decision_ante1_pair_full_prompt.txt")
